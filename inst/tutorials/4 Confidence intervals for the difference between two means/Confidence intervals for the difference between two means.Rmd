...
Here, $\bar{x}_1$ is the mean of sample 1 and $bar{x}_1$ is the mean for sample 2. Similarly, $s^2 _1$ is the variance of sample 1 and $s^2 _2$ is that of sample 2, and $n_1$ and $n_2$ are the sample sizes for samples 1 and 2 respectively.
