...
samples <- runif(n = 120, min = 0, max = 100)
...
# part in the lines of code wich begin
# samples <- 
```
...
```{r sampling3, exercise = TRUE, fig.height = 6}
...
Something else that might influence our sampling distribution is the amount of variability in the population that is being sampled from. Let's repeat the previous exercise but instead of changing the sample size for the second histogram try to change the standard deviation of the population being sampled from 17 to 10.

```{r sampling4, exercise = TRUE, fig.height = 6}
#Draw two plots one above the other
par(mfrow = c(2,1))
